...
/**
 * Servlet implementation class AssigneeHomePage
 */
@WebServlet("/AssigneeHomePage")
public class AssigneeHomePage extends HttpServlet {
...
//		pw.println("<html>");
//		pw.println("<body>");
//		pw.println("<h1>Assignee Home Page</h1>");
//		pw.println("</body>");
//		pw.println("</html>");
		...
		requests=rDAO.getRequestByAssId(String.valueOf(userId));
...
//		pw.println("<a href='/CampusHelpDesk/RequestorHomePage' id='hometag' >Home</a>");
		pw.println("<h1 class='mt-20'>Assigned Requests</h1>");
		...
		pw.println("<th scope=\"col\">Add Response</th>");
		pw.println("</tr>");
		pw.println("</thead>");
		pw.println("<tbody>");
		while(i.hasNext())
		{
			...
			if(userRequest.getStatus().equals("Assigned"))
			{
				pw.println("<td><form action='/CampusHelpDesk/AddResponse'>");
//				pw.println("<input type='text' class='form-control' name='response' /><br>");
				pw.println("<input type='hidden' name='requestId' value='"+userRequest.getRequestId()+"' />");
				pw.println("<input type='hidden' name='requestorId' value='"+userRequest.getRequestorId()+"' />");
				pw.println("<input type='hidden' name='facilityId' value='"+userRequest.getFacilityId()+"' />");
				pw.println("<textarea class='form-control' name='response' ></textarea><br>");
				pw.println("<input type='submit' class='btn btn-primary btn-large' value='Add Response' /></form></td>");
			}
			else
			{
				pw.println("<td> - </td>");
